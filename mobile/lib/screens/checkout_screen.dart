            ...
            child: ListView(
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        MoneyText(amountCents: _due, fontSize: 36, hero: true),
                        if (_rounding != 0)
                          Text(
                ...
                Wrap(
                  ...
                  children: [
                    for (final m in PayMethod.values)
                      ChoiceChip(
                        label: Text(switch (m) {
                          PayMethod.cash => '现金 Cash',
                          PayMethod.card => '卡 Card',
                          PayMethod.duitnow => 'DuitNow',
                          PayMethod.credit => '赊账 Credit',
                        }),
                        selected: _method == m,
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<Customer?>(
                      ...
                      onChanged: (c) async {
                        ...
                        if (c != null) {
                          final o = await widget.repo.customerOutstandingCents(c.id);
                ...
                if (_method == PayMethod.duitnow)
                  ...
                  Text(
                    change >= 0
                        ? '找零 / Change: ${formatRm(change)}'
                        : '金额不足 / Insufficient',
                    style: TextStyle(
                      color:
                          change >= 0 ? CnkhColors.success : CnkhColors.danger,
